...
export declare type CodegenBaseGeneratorConstructor<C = CodegenGeneratorContext> = (config: CodegenConfig, context: C) => Pick<CodegenGenerator, 'toEnumMemberName' | 'toIteratedSchemaName' | 'checkAllOfInheritanceCompatibility' | 'checkPropertyCompatibility'>;
/**
